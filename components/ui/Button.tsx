...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        'bg-dark-300 text-white hover:bg-dark-400 focus:ring-dark-500 dark:bg-dark-400 dark:hover:bg-dark-500',
      outline:
        'border-2 border-primary-600 text-primary-600 hover:bg-primary-50 focus:ring-primary-500 dark:border-primary-500 dark:text-primary-500 dark:hover:bg-dark-200',
      ghost:
        'text-gray-700 hover:bg-gray-100 focus:ring-gray-500 dark:text-dark-800 dark:hover:bg-dark-200',
      danger:
